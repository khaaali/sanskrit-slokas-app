  ...
  <section className="bg-white rounded-lg shadow p-4 mb-4">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-0">
      ...
      <article className="md:pr-6 md:border-r md:border-gray-200 text-center">
        <h3 className="font-extrabold text-xl mb-2 border-b border-gray-100 pb-1 text-center text-[#22304A] font-devanagari">मूलपाठ: <span className="text-sm text-gray-500 font-normal">(Original Text)</span></h3>
      ...
      <article className="md:px-6 md:border-r md:border-gray-200 text-center">
        <h3 className="font-extrabold text-xl mb-2 border-b border-gray-100 pb-1 text-center text-[#22304A] font-devanagari">लिप्यन्तरण <span className="text-sm text-gray-500 font-normal">(Transliteration)</span></h3>
        <div className="text-[#2C3E50] whitespace-pre-line text-center">
      ...
      <article className="md:pl-6 text-center">
        <div className="flex items-center justify-between mb-2 border-b border-gray-100 pb-1 w-full">
          <h3 className="font-extrabold text-xl flex items-center text-[#22304A] font-devanagari">अर्थः <span className="text-sm text-gray-500 font-normal ml-1">(Meaning)</span></h3>
